			...
			if(campaignIterator.hasNext())
			{
				...
				if(keywordIterators.hasNext())
				{
					while(keywordIterators.hasNext())
					{
						...
						{
							Logger.log("Notice!... New Bid ($"+new_bid+") is above Upper-Bid-Limit. Using Upper-Bid-Limit as the New-Bid.");
							new_bid = UPPER_BID_LIMIT;
							validNewBid = true;
						}
						else if(new_bid > TARGET_CPA)
						{
							Logger.log("Skipping!... New Bid ($"+new_bid+") is above Target CPA.");
							validNewBid = false;
						}
						else if(new_bid == 0)
						{
